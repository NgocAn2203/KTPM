...
driver.find_element(By.XPATH,'//*[@id="form-account"]/div[2]/div/div[2]/div/div/div[3]/div/label[1]').click()
...
driver.find_element(By.XPATH,'//*[@id="form-account"]/div[2]/div/div[2]/div/div/div[8]/button').click()
